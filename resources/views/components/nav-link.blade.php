...
@php
    $classes =
        $active ?? false
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-gold-400 text-sm font-medium leading-5 text-gray-100 focus:outline-none focus:border-gold-300 transition duration-150 ease-in-out'
