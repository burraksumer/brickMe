...
<head>
    ...
    <title>
        @if (Route::currentRouteName() === 'dashboard')
            Create Avatar - {{ config('app.name', 'Laravel') }}
        @elseif (Route::currentRouteName() === 'avatar.gallery')
            My Avatars - {{ config('app.name', 'Laravel') }}
        @elseif (str_contains(Route::currentRouteName(), 'profile'))
